# `apysc._material_design.icon.material_work_outline_icon` docstrings

## Module summary

Material icons' work outline icon class implementations.

## `MaterialWorkOutlineIcon` class docstring

Material icons' work outline icon class implementations.<hr>

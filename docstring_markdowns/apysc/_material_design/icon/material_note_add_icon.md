# `apysc._material_design.icon.material_note_add_icon` docstrings

## Module summary

Material icons' note add icon class implementation.

## `MaterialNoteAddIcon` class docstring

Material icons' note add icon class implementation.<hr>

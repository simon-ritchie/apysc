...
MAPPING: Dict[str, str] = {
    ...
    'The `animation_finish` interface finishes all running animations and sets the last attribute values of each animation setting.':  # noqa
    ...
    '**[Interface summary]** Finish all animations (set the animation last value to each attribute).<hr>':  # noqa

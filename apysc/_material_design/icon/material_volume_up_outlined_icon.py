...
class MaterialvolumeUpOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `volume_up` material icon.
    """

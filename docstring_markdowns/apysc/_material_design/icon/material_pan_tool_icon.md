# `apysc._material_design.icon.material_pan_tool_icon` docstrings

## Module summary

Material pan tool icon class implementation.

## `MaterialPanToolIcon` class docstring

Material pan tool icon class implementation.<hr>

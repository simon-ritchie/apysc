"""The test project for the AnimationLineAlphaInterface class.

Command examples:
$ python test_projects/AnimationLineAlphaInterface/main.py
"""
...
def main() -> None:
    ...
    sprite.graphics.line_style(color='#eee', thickness=3, alpha=1.0)
    rectangle: ap.Rectangle = sprite.graphics.draw_rect(
        x=50, y=50, width=50, height=50)
    animation_line_alpha: ap.AnimationLineAlpha = \
        rectangle.animation_line_alpha(
            alpha=0.5, duration=1000,

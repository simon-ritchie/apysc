# `apysc._material_design.icon.material_login_icon` docstrings

## Module summary

Material icons' login icon class implementations.

## `MaterialLoginIcon` class docstring

Material icons' login icon class implementations.<hr>

# `apysc._material_design.icon.material_flutter_dash_icon` docstrings

## Module summary

Material icons' flutter dash icon class implementation.

## `MaterialFlutterDashIcon` class docstring

Material icons' flutter dash icon class implementation.<hr>

# `apysc._material_design.icon.material_list_icon` docstrings

## Module summary

Material icons' list icon class implementations.

## `MaterialListIcon` class docstring

Material icons' list icon class implementations.<hr>

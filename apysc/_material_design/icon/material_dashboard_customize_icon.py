"""Material icons' dashboard customize icon class implementation.
"""
...
class MaterialDashboardCustomizeIcon(PathAndVarNameSettingBase):
    """
    Material icons' dashboard customize icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M3 3h8v8H3zm10 0h8v8h-8zM3 13h8v8H3zm15 0h-2v3h-3v2h3v3h2v-3h3v-2h-3z"
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_DASHBOARD_CUSTOMIZE_ICON
...
class TestLineStyleInterface:
    ...
    def test_line_style(self) -> None:
        ...
        line_style_interface.line_style(color="#333", thickness=3, alpha=0.5)
        ...
        line_style_interface.line_style(color="#333", dash_setting=line_dash_setting)
        ...
        line_style_interface.line_style(
            color="#333", round_dot_setting=line_round_dot_setting
        )
        assert line_style_interface._line_round_dot_setting == line_round_dot_setting
        ...
        assert line_style_interface._line_dash_dot_setting == line_dash_dot_setting

        line_style_interface.line_style(color="")
    ...
    def test_line_color(self) -> None:
        ...
        assert (
            line_color_1.variable_name != line_style_interface.line_color.variable_name
        )
    ...
    def test_line_alpha(self) -> None:
        ...
        assert line_alpha.variable_name != line_style_interface.line_alpha.variable_name
    ...
    def test__initialize_line_color_if_not_initialized(self) -> None:
        ...
        line_style_interface.line_style(color="#333", thickness=1, alpha=0.5)
        line_style_interface._initialize_line_color_if_not_initialized()
        assert line_style_interface.line_color == "#333333"
    ...
    def test__initialize_line_thickness_if_not_initialized(self) -> None:
        ...
        line_style_interface.line_style(color="#333", thickness=2, alpha=0.5)
        line_style_interface._initialize_line_thickness_if_not_initialized()
    ...
    def test__make_snapshot(self) -> None:
        ...
        line_style_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        assert line_style_interface._line_color_snapshots[snapshot_name] == "#333333"
        assert line_style_interface._line_thickness_snapshots[snapshot_name] == 3
        assert line_style_interface._line_alpha_snapshots[snapshot_name] == 0.5
        assert (
        ...
        assert (
            line_style_interface._line_dot_setting_snapshots[snapshot_name]
            == line_dot_setting
        )
        assert (
            line_style_interface._line_dash_setting_snapshots[snapshot_name]
            == line_dash_setting
        )
        assert (
            line_style_interface._line_round_dot_setting_snapshots[snapshot_name]
            == line_round_dot_setting
        )
        assert (
            line_style_interface._line_dash_dot_setting_snapshots[snapshot_name]
            == line_dash_dot_setting
        )

        line_style_interface.line_style(color="#222", thickness=2, alpha=0.3)
        line_style_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        assert line_style_interface._line_color_snapshots[snapshot_name] == "#333333"
    ...
    def test__revert(self) -> None:
        ...
        line_style_interface._run_all_revert_methods(snapshot_name=snapshot_name)
        assert line_style_interface.line_color == "#333333"
        assert line_style_interface.line_thickness == 3
        assert line_style_interface.line_alpha == 0.5
        ...
        assert line_style_interface.line_round_dot_setting == line_round_dot_setting
        assert line_style_interface.line_dash_dot_setting == line_dash_dot_setting
    ...
    def test__set_line_joints(self) -> None:
        ...
        line_style_interface.line_style(color="#333", joints=ap.LineJoints.BEVEL)
    ...
    def test__initialize_line_joints_if_not_initialized(self) -> None:
        ...
        line_style_interface._line_joints = ap.String(ap.LineJoints.BEVEL.value)
        line_style_interface._initialize_line_joints_if_not_initialized()
        assert line_style_interface._line_joints == ap.LineJoints.BEVEL.value
    ...
    def test__initialize_line_round_dot_setting_if_not_initialized(self) -> None:
        line_style_interface: LineStyleInterface = LineStyleInterface()
        line_style_interface._initialize_line_round_dot_setting_if_not_initialized()
    ...
    def test__initialize_line_dash_dot_setting_if_not_initialized(self) -> None:
        line_style_interface: LineStyleInterface = LineStyleInterface()
        line_style_interface._initialize_line_dash_dot_setting_if_not_initialized()
    ...
    def test__convert_line_alpha_to_number(self) -> None:
        ...
        alpha: ap.Number = line_style_interface._convert_line_alpha_to_number(
            alpha=ap.Number(0.5)
        )
        assert alpha == 0.5
        assert isinstance(alpha, ap.Number)

        alpha = line_style_interface._convert_line_alpha_to_number(alpha=0.3)
        assert alpha == 0.3
        assert isinstance(alpha, ap.Number)
    ...
    def test__convert_line_thickness_to_apysc_int(self) -> None:
        ...
        thickness: ap.Int = line_style_interface._convert_line_thickness_to_apysc_int(
            thickness=ap.Int(10)
        )
        assert thickness == 10
        assert isinstance(thickness, ap.Int)

        thickness = line_style_interface._convert_line_thickness_to_apysc_int(
            thickness=5
        )
        assert thickness == 5
        assert isinstance(thickness, ap.Int)

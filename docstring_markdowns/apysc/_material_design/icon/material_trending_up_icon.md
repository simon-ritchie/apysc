# `apysc._material_design.icon.material_trending_up_icon` docstrings

## Module summary

Material icons' trending up icon class implementations.

## `MaterialTrendingUpIcon` class docstring

Material icons' trending up icon class implementations.<hr>

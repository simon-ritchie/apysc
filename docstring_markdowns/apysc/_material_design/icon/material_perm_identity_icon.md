# `apysc._material_design.icon.material_perm_identity_icon` docstrings

## Module summary

Material icons' perm identity icon class implementations.

## `MaterialPermIdentityIcon` class docstring

Material icons' perm identity icon class implementations.<hr>

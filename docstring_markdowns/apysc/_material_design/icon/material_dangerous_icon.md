# `apysc._material_design.icon.material_dangerous_icon` docstrings

## Module summary

Material icons' dangerous icon class implementation.

## `MaterialDangerousIcon` class docstring

Material icons' dangerous icon class implementation.<hr>

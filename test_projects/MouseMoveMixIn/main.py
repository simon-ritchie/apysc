"""Test project for MouseMoveMixIn class.

Command examples:
$ python test_projects/MouseMoveMixIn/main.py
"""
...
def main() -> None:
    ...
    rectangle_1.mousemove(handler=on_rectangle_1_mouse_move, options=options)
...
def on_rectangle_1_mouse_move(e: ap.MouseEvent, options: _MsgOptions) -> None:
    """
...
def on_rectangle_2_mouse_move(e: ap.MouseEvent, options: dict) -> None:
    """
...
def on_rectangle_3_mouse_move(e: ap.MouseEvent, options: dict) -> None:
    """

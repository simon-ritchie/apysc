...
def on_rectangle_1_click(e: ap.MouseEvent[ap.Rectangle], options: dict) -> None:
    """
...
def on_rectangle_2_click(e: ap.MouseEvent[ap.Rectangle], options: dict) -> None:
    """
    The handler called when a rectangle is clicked.
...
def on_rectangle_3_click(e: ap.MouseEvent, options: dict) -> None:
    """
    The handler called when a rectangle is clicked.
...
def on_rectangle_4_click(e: ap.MouseEvent[ap.Rectangle], options: dict) -> None:
    """
    The handler called when a rectangle is clicked.
...
def on_sprite_2_click(e: ap.MouseEvent[ap.Sprite], options: dict) -> None:
    """

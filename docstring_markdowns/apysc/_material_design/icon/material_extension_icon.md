# `apysc._material_design.icon.material_extension_icon` docstrings

## Module summary

Material icons' extension icon class implementation.

## `MaterialExtensionIcon` class docstring

Material icons' extension icon class implementation.<hr>

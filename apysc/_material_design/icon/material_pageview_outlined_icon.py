...
class MaterialpageviewOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `pageview` material icon.
    """

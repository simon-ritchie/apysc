# `apysc._material_design.icon.material_circle_up_icon` docstrings

## Module summary

Material icons' circle up icon class implementation.

## `MaterialCircleUpIcon` class docstring

Material icons' circle up icon class implementation.<hr>

# `apysc._material_design.icon.material_history_icon` docstrings

## Module summary

Material icons' history icon class implementations.

## `MaterialHistoryIcon` class docstring

Material icons' history icon class implementations.<hr>

# `apysc._material_design.icon.material_view_list_icon` docstrings

## Module summary

Material icons' view list icon class implementations.

## `MaterialViewListIcon` class docstring

Material icons' view list icon class implementations.<hr>

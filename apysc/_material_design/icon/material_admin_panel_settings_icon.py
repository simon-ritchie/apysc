...
class MaterialadminPanelSettingsIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the `admin_panel_settings` material icon.
    """

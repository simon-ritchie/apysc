...
class MaterialpersonSearchOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `person_search` material icon.
    """

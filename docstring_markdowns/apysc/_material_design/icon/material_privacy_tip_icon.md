# `apysc._material_design.icon.material_privacy_tip_icon` docstrings

## Module summary

Material icons' privacy tip icon class implementation.

## `MaterialPrivacyTipIcon` class docstring

Material icons' privacy tip icon class implementation.<hr>

...
class MaterialSpaceDashboardIcon(PathAndVarNameSettingBase):
    """
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M11,21H5c-1.1,0-2-0.9-2-2V5c0-1.1,0.9-2,2-2h6V21z M13,21h6c1.1,0,2-0.9,2-2v-7h-8V21z M21,10V5c0-1.1-0.9-2-2-2h-6v7H21z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_SPACE_DASHBOARD_ICON

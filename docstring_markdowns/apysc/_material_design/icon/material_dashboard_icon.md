# `apysc._material_design.icon.material_dashboard_icon` docstrings

## Module summary

Material icons' dashboard icon class implementations.

## `MaterialDashboardIcon` class docstring

Material icons' dashboard icon class implementations.<hr>

# `apysc._material_design.icon.material_book_icon` docstrings

## Module summary

Material icons' book icon class implementations.

## `MaterialBookIcon` class docstring

Material icons' book icon class implementations.<hr>

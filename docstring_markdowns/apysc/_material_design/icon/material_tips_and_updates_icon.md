# `apysc._material_design.icon.material_tips_and_updates_icon` docstrings

## Module summary

Material icons' tips and updates icon class implementations.

## `MaterialTipsAndUpdatesIcon` class docstring

Material icons' tips and updates icon class implementations.<hr>

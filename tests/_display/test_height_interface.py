...
class TestHeightInterface:
    ...
    def test__append_height_update_expression(self) -> None:
        ...
        match: Optional[Match] = re.search(
            pattern=(rf"test_height_interface\.height\({var_names.INT}_.+?\);"),
            string=expression,
            flags=re.MULTILINE,
        )
    ...
    def test__update_height_and_skip_appending_exp(self) -> None:
        height_interface: HeightInterface = HeightInterface()
        expression_data_util.empty_expression()
        height_interface._update_height_and_skip_appending_exp(value=ap.Int(300))
        ...
        height_interface._update_height_and_skip_appending_exp(value=400)
    ...
    def test__make_snapshot(self) -> None:
        ...
        height_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
    ...
    def test__revert(self) -> None:
        ...
        height_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        height_interface.height = ap.Int(5)
        height_interface._run_all_revert_methods(snapshot_name=snapshot_name)
        assert height_interface.height == 10

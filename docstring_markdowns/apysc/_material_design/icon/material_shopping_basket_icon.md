# `apysc._material_design.icon.material_shopping_basket_icon` docstrings

## Module summary

Material icons' shopping basket icon class implementations.

## `MaterialShoppingBasketIcon` class docstring

Material icons' shopping basket icon class implementations.<hr>

...
class TestLineRoundDotSettingInterface:
    ...
    def test__initialize_line_round_dot_setting_if_not_initialized(self) -> None:
        interface: LineRoundDotSettingInterface = LineRoundDotSettingInterface()
        ...
        interface._initialize_line_round_dot_setting_if_not_initialized()
        assert isinstance(interface._line_round_dot_setting, ap.LineRoundDotSetting)
    ...
    def test__update_line_round_dot_setting_and_skip_appending_exp(self) -> None:
        ...
        interface._update_line_round_dot_setting_and_skip_appending_exp(value=None)
        assert interface._line_round_dot_setting is None

        assert_raises(
            expected_error_class=TypeError,
            callable_=interface._update_line_round_dot_setting_and_skip_appending_exp,
    ...
    def test__append_line_round_dot_setting_update_expression(self) -> None:
        ...
        expected: str = f"{interface.variable_name}.css" f'("stroke-dasharray", "");'
    ...
    def test__make_snapshot(self) -> None:
        ...
        assert (
            interface._line_round_dot_setting_snapshots[snapshot_name]

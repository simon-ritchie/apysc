# `apysc._material_design.icon.material_setting_phone_icon` docstrings

## Module summary

Material icons' setting phone icon class implementation.

## `MaterialSettingPhoneIcon` class docstring

Material icons' setting phone icon class implementation.<hr>

"""Test project for MouseUpMixIn class.

Command examples:
$ python test_projects/MouseUpMixIn/main.py
"""
...
def on_rectangle_1_mouse_up(e: ap.MouseEvent, options: _MsgOptions) -> None:
    """
...
def on_rectangle_2_mouse_up(e: ap.MouseEvent, options: dict) -> None:
    """
...
def on_rectangle_3_mouse_up(e: ap.MouseEvent, options: dict) -> None:
    """

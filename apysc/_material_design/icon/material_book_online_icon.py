"""Material icons' book online icon class implementation.
"""
...
class MaterialBookOnlineIcon(PathAndVarNameSettingBase):
    """
    Material icons' book online icon class implementation.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_BOOK_ONLINE_ICON

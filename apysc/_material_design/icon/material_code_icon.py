...
class MaterialCodeIcon(PathAndVarNameSettingBase):
    """
    Material icons' code icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_CODE_ICON

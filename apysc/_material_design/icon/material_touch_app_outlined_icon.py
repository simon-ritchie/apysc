...
class MaterialtouchAppOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `touch_app` material icon.
    """

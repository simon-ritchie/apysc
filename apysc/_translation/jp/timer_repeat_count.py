...
MAPPING: Dict[str, str] = {
    ...
    "**[References]**": "**[関連資料]**",
    ##################################################
    "- [Timer document](https://simon-ritchie.github.io/apysc/en/timer.html)": "- [Timer クラス](https://simon-ritchie.github.io/apysc/en/jp_timer.html)",  # noqa
    ##################################################
    "- [TimerEvent class document](https://simon-ritchie.github.io/apysc/en/timer_event.html)": "- [TimerEvent クラス](https://simon-ritchie.github.io/apysc/en/jp_timer_event.html)",  # noqa
    ##################################################
    "- [Timer class delay setting document](https://simon-ritchie.github.io/apysc/en/timer_delay.html)": "- [Timer クラスの delay 設定](https://simon-ritchie.github.io/apysc/en/jp_timer_delay.html)",  # noqa
    ##################################################
    "- [FPS enum document](https://simon-ritchie.github.io/apysc/en/fps.html)": "- [FPS の enum](https://simon-ritchie.github.io/apysc/en/jp_fps.html)",  # noqa
    ##################################################

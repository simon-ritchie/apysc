...
class MaterialFlightTakeoffIcon(PathAndVarNameSettingBase):
    """
    Material icons' flight takeoff icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M2.5,19h19v2h-19V19z M22.07,9.64c-0.21-0.8-1.04-1.28-1.84-1.06L14.92,10l-6.9-6.43L6.09,4.08l4.14,7.17l-4.97,1.33 l-1.97-1.54l-1.45,0.39l2.59,4.49c0,0,7.12-1.9,16.57-4.43C21.81,11.26,22.28,10.44,22.07,9.64z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_FLIGHT_TAKEOFF_ICON

# `apysc._material_design.icon.material_contact_page_icon` docstrings

## Module summary

Material icons' contact page icon class implementation.

## `MaterialContactPageIcon` class docstring

Material icons' contact page icon class implementation.<hr>

# `apysc._animation.animation_scale_x_from_point_interface` docstrings

## Module summary

Class implementation for the animation_scale_x_from_point interface.
...
- [animation_scale_x_from_point interface document](https://simon-ritchie.github.io/apysc/en/animation_scale_x_and_y_from_point.html)

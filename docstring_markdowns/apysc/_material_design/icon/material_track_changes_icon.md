# `apysc._material_design.icon.material_track_changes_icon` docstrings

## Module summary

Material icons' track changes icon class implementation.

## `MaterialTrackChangesIcon` class docstring

Material icons' track changes icon class implementation.<hr>

...
MAPPING: Dict[str, str] = {
    ...
    '<iframe src="static/animation_rotation_around_center_basic_usage/index.html" width="150" height="150"></iframe>':  # noqa
    '',

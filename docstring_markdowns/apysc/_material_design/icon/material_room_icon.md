# `apysc._material_design.icon.material_room_icon` docstrings

## Module summary

Material icons' room icon class implementations.

## `MaterialRoomIcon` class docstring

Material icons' room icon class implementations.<hr>

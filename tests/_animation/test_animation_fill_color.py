...
class TestAnimationFillColor:
    ...
    def test__make_snapshot(self) -> None:
        ...
        animation_fill_color: ap.AnimationFillColor = ap.AnimationFillColor(
            target=target, fill_color='0af')
        snapshot_name: str = animation_fill_color._get_next_snapshot_name()
        animation_fill_color._run_all_make_snapshot_methods(
            snapshot_name=snapshot_name)
        assert animation_fill_color._fill_color_snapshots[snapshot_name] \
            == '#00aaff'

        animation_fill_color._fill_color.value = '#ff00aa'
        animation_fill_color._run_all_make_snapshot_methods(
            snapshot_name=snapshot_name)
        assert animation_fill_color._fill_color_snapshots[snapshot_name] \
            == '#00aaff'
    ...
    def test__revert(self) -> None:
        ...
        animation_fill_color._run_all_make_snapshot_methods(
            snapshot_name=snapshot_name)
        animation_fill_color._fill_color.value = '#ff00aa'
        animation_fill_color._run_all_revert_methods(
            snapshot_name=snapshot_name)
        assert animation_fill_color._fill_color == '#00aaff'

        animation_fill_color._fill_color.value = '#ff00aa'
        animation_fill_color._run_all_revert_methods(
            snapshot_name=snapshot_name)
        assert animation_fill_color._fill_color == '#ff00aa'

...
class Material3DRotationOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `3d_rotation` material icon.
    """

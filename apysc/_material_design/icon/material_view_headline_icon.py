...
class MaterialViewHeadlineIcon(PathAndVarNameSettingBase):
    """
    Material icons' view headline icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M4 15h16v-2H4v2zm0 4h16v-2H4v2zm0-8h16V9H4v2zm0-6v2h16V5H4z"
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_VIEW_HEADLINE_ICON

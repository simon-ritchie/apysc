...
class MaterialfavoriteBorderOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `favorite_border` material icon.
    """

...
MAPPING: Dict[str, str] = {
    ...
    "**[References]**": "**[関連資料]**",
    ##################################################
    "- [True_ and False_ constants](https://simon-ritchie.github.io/apysc/en/true_and_false.html)": "- [True_ と False_ の各定数](https://simon-ritchie.github.io/apysc/jp/jp_true_and_false.html)",  # noqa
    ##################################################

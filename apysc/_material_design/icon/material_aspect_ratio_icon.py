"""Material icons' aspect ratio icon class implementation.
"""
...
class MaterialAspectRatioIcon(PathAndVarNameSettingBase):
    """
    Material icons' aspect ratio icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M19 12h-2v3h-3v2h5v-5zM7 9h3V7H5v5h2V9zm14-6H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16.01H3V4.99h18v14.02z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_ASPECT_RATIO_ICON

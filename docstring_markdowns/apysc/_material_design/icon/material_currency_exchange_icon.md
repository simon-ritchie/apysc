# `apysc._material_design.icon.material_currency_exchange_icon` docstrings

## Module summary

Material icons' currency exchange icon class implementation.

## `MaterialCurrencyExchangeIcon` class docstring

Material icons' currency exchange icon class implementation.<hr>

...
class MaterialBookmarkBorderIcon(PathAndVarNameSettingBase):
    """
    Material icons' bookmark border icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V5h10v13z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_BOOKMARK_BORDER_ICON

"""Material icons' published with changes icon class implementations.
"""
...
class MaterialPublishedWithChangesIcon(PathAndVarNameSettingBase):
    """
    Material icons' published with changes icon class implementations.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_PUBLISHED_WITH_CHANGES_ICON

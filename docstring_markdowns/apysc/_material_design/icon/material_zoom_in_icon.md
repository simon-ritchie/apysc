# `apysc._material_design.icon.material_zoom_in_icon` docstrings

## Module summary

Material icons' zoom-in icon class implementations.

## `MaterialZoomInIcon` class docstring

Material icons' zoom-in icon class implementations.<hr>

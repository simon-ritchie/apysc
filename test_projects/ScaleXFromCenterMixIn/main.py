"""The test project for the ScaleXFromCenterMixIn class.

Command examples:
$ python test_projects/ScaleXFromCenterMixIn/main.py
"""
...
def main() -> None:
    ...
    timer_2: ap.Timer = ap.Timer(on_timer_2, delay=ap.FPS.FPS_60, options=options)
    timer_2.start()

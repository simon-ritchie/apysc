# `apysc._material_design.icon.material_thumb_up_icon` docstrings

## Module summary

Material icons' thumb up icon class implementation.

## `MaterialThumbUpIcon` class docstring

Material icons' thumb up icon class implementation.<hr>

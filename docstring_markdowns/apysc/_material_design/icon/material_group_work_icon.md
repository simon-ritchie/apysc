# `apysc._material_design.icon.material_group_work_icon` docstrings

## Module summary

Material icons' group work icon class implementation.

## `MaterialGroupWorkIcon` class docstring

Material icons' group work icon class implementation.<hr>

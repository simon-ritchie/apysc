...
class MaterialAccessibilityNewIcon(PathAndVarNameSettingBase):
    """
    Material icons' accessibility new icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M20.5 6c-2.61.7-5.67 1-8.5 1s-5.89-.3-8.5-1L3 8c1.86.5 4 .83 6 1v13h2v-6h2v6h2V9c2-.17 4.14-.5 6-1l-.5-2zM12 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_ACCESSIBILITY_NEW_ICON

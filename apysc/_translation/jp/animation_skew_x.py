...
MAPPING: Dict[str, str] = {
    ##################################################
    "# animation_skew_x interface": "# animation_skew_x インターフェイス",
    ##################################################
    "This page explains the `animation_skew_x` method interface.": "このページでは`animation_skew_x`メソッドのインターフェイスについて説明します。",  # noqa
    ##################################################
    "## What interface is this?": "## インターフェイス概要",
    ##################################################
    "The `animation_skew_x` method interface creates an `ap.AnimationSkewX` instance. You can animate x-directional skewing with it.": "`animation_skew_x`メソッドのインターフェイスは`ap.AnimationSkewX`のインスタンスを生成します。そのインスタンスを使ってX軸方向の傾きのアニメーションを設定することができます。",  # noqa
    ##################################################
    "This interface exists on a `GraphicsBase` subclass, such as the `Rectangle` class.": "このインターフェイスは`Rectangle`などの`GraphicsBase`の各サブクラス上に存在します。",  # noqa
    ##################################################
    "## Basic usage": "## 基本的な使い方",
    ##################################################
    "The following example sets the skew-x animation (from 0 to 50) with the `animation_skew_x` method:": "以下のコード例ではX軸方向の傾きのアニメーション（0から50）を`animation_skew_x`メソッドを使って設定しています。",  # noqa
    ##################################################
    ...
    ##################################################
    "## animation_skew_x API": "## animation_skew_x API",
    ##################################################
    '<span class="inconspicuous-txt">Note: the document build script generates and updates this API document section automatically. Maybe this section is duplicated compared with previous sections.</span>': '<span class="inconspicuous-txt">特記事項: このAPIドキュメントはドキュメントビルド用のスクリプトによって自動で生成・同期されています。そのためもしかしたらこの節の内容は前節までの内容と重複している場合があります。</span>',  # noqa
    ##################################################
    "**[Interface summary]** Set the skew-x animation setting.<hr>": "**[インターフェイス概要]** X軸の傾きのアニメーションを設定します。<hr>",  # noqa
    ##################################################
    "**[Parameters]**": "**[引数]**",
    ##################################################
    "- `skew_x`: Int or int": "- `skew_x`: Int or int",
    ##################################################
    "  - The final skew-x of the animation.": "  - X軸の傾きのアニメーションの最終値。",
    ##################################################
    ...
    "**[Returns]**": "**[返却値]**",
    ##################################################
    "- `animation_skew_x`: AnimationSkewX": "- `animation_skew_x`: AnimationSkewX",
    ##################################################

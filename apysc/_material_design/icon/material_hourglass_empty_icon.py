...
class MaterialHourglassEmptyIcon(PathAndVarNameSettingBase):
    """
    Material icons' hourglass empty icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6zm10 14.5V20H8v-3.5l4-4 4 4zm-4-5l-4-4V4h8v3.5l-4 4z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_HOURGLASS_EMPTY_ICON

...
class PathControlX2MixIn(
    ...
    _control_x2_snapshots: Optional[Dict[str, float]] = None
    ...
    def _revert(self, *, snapshot_name: str) -> None:
        ...
        """
        self._initialize_control_x2_if_not_initialized()
        self._control_x2._value = self._get_snapshot_val_if_exists(
            current_value=self._control_x2._value,
            snapshot_dict=self._control_x2_snapshots,
            snapshot_name=snapshot_name,
        )

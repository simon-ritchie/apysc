# `apysc._material_design.icon.material_delete_outline_icon` docstrings

## Module summary

Material icons' delete outline icon class implementations.

## `MaterialDeleteOutlineIcon` class docstring

Material icons' delete outline icon class implementations.<hr>

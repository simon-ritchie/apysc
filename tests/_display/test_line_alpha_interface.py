...
class TestLineAlphaInterface:
    ...
    def test__update_line_alpha_and_skip_appending_exp(self) -> None:
        ...
        line_alpha_interface._update_line_alpha_and_skip_appending_exp(value=0.3)
        assert line_alpha_interface.line_alpha == 0.3
    ...
    def test__make_snapshot(self) -> None:
        ...
        line_alpha_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        assert line_alpha_interface._line_alpha_snapshots[snapshot_name] == 0.5
    ...
    def test__revert(self) -> None:
        ...
        line_alpha_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        line_alpha_interface.line_alpha = ap.Number(0.3)
        line_alpha_interface._run_all_revert_methods(snapshot_name=snapshot_name)
        assert line_alpha_interface.line_alpha == 0.5

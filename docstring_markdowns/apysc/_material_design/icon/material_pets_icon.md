# `apysc._material_design.icon.material_pets_icon` docstrings

## Module summary

Material icons' pets icon class implementations.

## `MaterialPetsIcon` class docstring

Material icons' pets icon class implementations.<hr>

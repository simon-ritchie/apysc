...
class MaterialExploreIcon(PathAndVarNameSettingBase):
    """
    Material icons' explore icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M12 10.9c-.61 0-1.1.49-1.1 1.1s.49 1.1 1.1 1.1c.61 0 1.1-.49 1.1-1.1s-.49-1.1-1.1-1.1zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2.19 12.19L6 18l3.81-8.19L18 6l-3.81 8.19z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_EXPLORE_ICON

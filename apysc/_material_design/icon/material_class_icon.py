"""Material icons' class icon class implementation.
"""
...
class MaterialClassIcon(PathAndVarNameSettingBase):
    """
    Material icons' class icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_CLASS_ICON

...
def add_alphabets_group_arg_to_parser(*, parser: ArgumentParser) -> None:
    """
...
def split_alphabets_group_str(*, alphabets_group_str: str) -> List[str]:
    """
    ...
    if alphabets_group_str == "":
        raise ValueError("An `--alphabets_group` argument' value cannot be blank.")
    alphabets_group: List[str] = []

...
class MaterialtableViewOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `table_view` material icon.
    """

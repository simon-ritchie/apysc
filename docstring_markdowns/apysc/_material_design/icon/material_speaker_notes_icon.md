# `apysc._material_design.icon.material_speaker_notes_icon` docstrings

## Module summary

Material icons' speaker notes icon class implementation.

## `MaterialSpeakerNotesIcon` class docstring

Material icons' speaker notes icon class implementation.<hr>

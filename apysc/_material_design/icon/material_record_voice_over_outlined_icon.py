...
class MaterialrecordVoiceOverOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `record_voice_over` material icon.
    """

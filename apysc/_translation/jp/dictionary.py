...
MAPPING: Dict[str, str] = {
    ...
    '- [Dictionary class generic type settings document](https://simon-ritchie.github.io/apysc/en/dictionary_generic.html)':  # noqa
    '- [Dictionary クラスのジェネリックの型設定](https://simon-ritchie.github.io/apysc/en/jp_dictionary_generic.html)',  # noqa

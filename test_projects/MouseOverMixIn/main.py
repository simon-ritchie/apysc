...
def main() -> None:
    ...
    rectangle_1.mouseover(handler=on_rectangle_1_mouse_over, options=options)
...
def on_rectangle_1_mouse_over(e: ap.MouseEvent, options: _MsgOptions) -> None:
    """
...
def on_rectangle_2_mouse_over(e: ap.MouseEvent, options: dict) -> None:
    """
...
def on_rectangle_3_mouse_over(e: ap.MouseEvent, options: dict) -> None:
    """

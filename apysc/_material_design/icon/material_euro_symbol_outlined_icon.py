...
class MaterialeuroSymbolOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `euro_symbol` material icon.
    """

...
class MaterialPausePresentationIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the `pause_presentation` material icon.
    """

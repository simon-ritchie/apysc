...
class MaterialdeleteForeverOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `delete_forever` material icon.
    """

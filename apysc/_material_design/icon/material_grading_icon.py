"""Material icons' grading icon class implementation.
"""
...
class MaterialGradingIcon(PathAndVarNameSettingBase):
    """
    Material icons' grading icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M4,7h16v2H4V7z M4,13h16v-2H4V13z M4,17h7v-2H4V17z M4,21h7v-2H4V21z M15.41,18.17L14,16.75l-1.41,1.41L15.41,21L20,16.42 L18.58,15L15.41,18.17z M4,3v2h16V3H4z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_GRADING_ICON

...
MAPPING: Dict[str, str] = {
    ...
    ##################################################
    "The `PathBezier2DContinual` class has the restriction, and you can use this class only after the `PathBezier2D` or `PathBezier2DContinual`.": "`PathBezier2DContinual`クラスは`PathBezier2D`もしくは`PathBezier2DContinual`クラスの直後でのみ使用することができるという制限があります。",  # noqa
    ##################################################
    ...
    ##################################################
    "**[Interface summary]** Path data class for the SVG `continual 2D bezier curve` (T).<hr>": "**[インターフェイス概要]** SVGの連続した2次元のベジェ曲線のデータ設定用のクラスです。<hr>",  # noqa
    ##################################################
    "**[Parameters]**": "**[引数]**",
    ##################################################
    ...
    "**[References]**": "**[関連資料]**",
    ##################################################
    "- [Path class](https://simon-ritchie.github.io/apysc/en/path.html)": "- [Path クラス](https://simon-ritchie.github.io/apysc/en/jp_path.html)",  # noqa
    ##################################################

# `apysc._animation.animation_scale_y_from_point_interface` docstrings
...
- [animation_scale_from_point interfaces document](https://simon-ritchie.github.io/apysc/en/animation_scale_x_and_y_from_point.html)

...
class TestXInterface:
    ...
    def test__append_x_update_expression(self) -> None:
        ...
        value_str: str = value_util.get_value_str_for_expression(value=x_interface._x)
    ...
    def test__make_snapshot(self) -> None:
        ...
        x_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
    ...
    def test__revert(self) -> None:
        ...
        x_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        x_interface.x = ap.Int(150)
        x_interface._run_all_revert_methods(snapshot_name=snapshot_name)
        assert x_interface.x == 100

# `apysc._material_design.icon.material_exit_to_app_icon` docstrings

## Module summary

Material icons' exit to app icon class implementations.

## `MaterialExitToAppIcon` class docstring

Material icons' exit to app icon class implementations.<hr>

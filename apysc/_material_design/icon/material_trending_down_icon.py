"""Material icons' trending down icon class implementation.
"""
...
class MaterialTrendingDownIcon(PathAndVarNameSettingBase):
    """
    Material icons' trending down icon class implementation.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_TRENDING_DOWN_ICON

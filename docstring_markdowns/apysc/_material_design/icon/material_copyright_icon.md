# `apysc._material_design.icon.material_copyright_icon` docstrings

## Module summary

Material icons' copyright icon class implementation.

## `MaterialCopyrightIcon` class docstring

Material icons' copyright icon class implementation.<hr>

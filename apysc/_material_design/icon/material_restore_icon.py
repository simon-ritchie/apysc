"""Material icons' restore icon class implementation.
"""
...
class MaterialRestoreIcon(PathAndVarNameSettingBase):
    """
    Material icons' restore icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_RESTORE_ICON

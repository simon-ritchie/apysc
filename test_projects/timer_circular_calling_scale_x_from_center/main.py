...
updating scale-x from the center coordinates interface value.

Command examples:
$ python test_projects/timer_circular_calling_scale_x_from_center/main.py
$ python timer_circular_calling_scale_x_from_center/main.py
"""
...
def on_timer_1(e: ap.TimerEvent, options: Dict[str, Any]) -> None:
    ...
    rectangle.scale_x_from_center += 0.005

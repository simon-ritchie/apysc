# `apysc._material_design.icon.material_assignment_ind_icon` docstrings

## Module summary

Material icons' assignment ind icon class implementations.

## `MaterialAssignmentIndIcon` class docstring

Material icons' assignment ind icon class implementations.<hr>

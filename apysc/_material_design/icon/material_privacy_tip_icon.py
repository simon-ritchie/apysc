...
class MaterialPrivacyTipIcon(PathAndVarNameSettingBase):
    """
    Material icons' privacy tip icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M12,1L3,5v6c0,5.55,3.84,10.74,9,12c5.16-1.26,9-6.45,9-12V5L12,1L12,1z M11,7h2v2h-2V7z M11,11h2v6h-2V11z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_PRIVACY_TIP_ICON

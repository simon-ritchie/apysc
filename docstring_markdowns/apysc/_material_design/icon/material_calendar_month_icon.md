# `apysc._material_design.icon.material_calendar_month_icon` docstrings

## Module summary

Material icons' calendar month icon class implementations.

## `MaterialCalendarMonthIcon` class docstring

Material icons' calendar month icon class implementations.<hr>

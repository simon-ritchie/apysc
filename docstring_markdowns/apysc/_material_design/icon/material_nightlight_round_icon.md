# `apysc._material_design.icon.material_nightlight_round_icon` docstrings

## Module summary

Material nightlight round icon class implementation.

## `MaterialNightlightRoundIcon` class docstring

Material nightlight round icon class implementation.<hr>

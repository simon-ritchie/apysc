# `apysc._material_design.icon.material_delete_forever_icon` docstrings

## Module summary

Material icons' delete forever icon class implementations.

## `MaterialDeleteForeverIcon` class docstring

Material icons' delete forever icon class implementations.<hr>

# `apysc._material_design.icon.material_date_range_icon` docstrings

## Module summary

Material icons' date range icon class implementation.

## `MaterialDateRangeIcon` class docstring

Material icons' date range icon class implementation.<hr>

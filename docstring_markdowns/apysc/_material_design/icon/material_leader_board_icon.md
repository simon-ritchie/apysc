# `apysc._material_design.icon.material_leader_board_icon` docstrings

## Module summary

Material icons' leader board icon class implementations.

## `MaterialLeaderBoardIcon` class docstring

Material icons' leader board icon class implementations.<hr>

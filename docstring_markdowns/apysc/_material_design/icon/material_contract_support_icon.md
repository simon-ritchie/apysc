# `apysc._material_design.icon.material_contract_support_icon` docstrings

## Module summary

Material icons' contract support icon class implementations.

## `MaterialContractSupportIcon` class docstring

Material icons' contract support icon class implementations.<hr>

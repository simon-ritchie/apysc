# `apysc._material_design.icon.material_filter_alt_icon` docstrings

## Module summary

Material icons' filter alt icon class implementation.

## `MaterialFilterAltIcon` class docstring

Material icons' filter alt icon class implementation.<hr>

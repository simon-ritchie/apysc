...
class MaterialSupervisorAccountIcon(PathAndVarNameSettingBase):
    """
    Material icons' supervisor account icon class implementations.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_SUPERVISOR_ACCOUNT_ICON

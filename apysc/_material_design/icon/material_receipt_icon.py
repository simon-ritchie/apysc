"""Material icons' receipt icon class implementations.
"""
...
class MaterialReceiptIcon(PathAndVarNameSettingBase):
    """
    Material icons' receipt icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M18 17H6v-2h12v2zm0-4H6v-2h12v2zm0-4H6V7h12v2zM3 22l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2v20z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_RECEIPT_ICON

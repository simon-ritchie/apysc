# `apysc._animation.animation_reverse_mixin` docstrings

## Module summary

Class implementation for the animation_reverse mix-in.

## `AnimationReverseMixIn` class docstring
...
- [animation_reverse interface](https://simon-ritchie.github.io/apysc/en/animation_reverse.html)
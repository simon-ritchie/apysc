...
class TestLineThicknessInterface:
    ...
    def test_line_thickness(self) -> None:
        line_thickness_interface: LineThicknessInterface = LineThicknessInterface()
        line_thickness_interface.variable_name = "test_line_thickness_interface"
    ...
    def test__update_line_thickness_and_skip_appending_exp(self) -> None:
        ...
        line_thickness_interface._update_line_thickness_and_skip_appending_exp(value=6)
    ...
    def test__initialize_line_thickness_if_not_initialized(self) -> None:
        line_thickness_interface: LineThicknessInterface = LineThicknessInterface()
        line_thickness_interface.variable_name = "test_line_thickness_interface"
        line_thickness_interface._initialize_line_thickness_if_not_initialized()
    ...
    def test__make_snapshot(self) -> None:
        ...
        assert line_thickness_interface._line_thickness_snapshots[snapshot_name] == 3
    ...
    def test__revert(self) -> None:
        ...
        line_thickness_interface.line_thickness = ap.Int(2)
        line_thickness_interface._run_all_revert_methods(snapshot_name=snapshot_name)
        assert line_thickness_interface.line_thickness == 3

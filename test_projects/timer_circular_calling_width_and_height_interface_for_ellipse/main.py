...
$ python timer_circular_calling_width_and_height_interface_for_ellipse/main.py
"""
...
class _EllipseOptions(TypedDict):
    ellipse: ap.Ellipse
...
def on_timer_1(e: ap.TimerEvent, options: _EllipseOptions) -> None:
    """
...
def on_timer_complete_1(e: ap.TimerEvent, options: _EllipseOptions) -> None:
    """
...
def on_timer_2(e: ap.TimerEvent, options: _EllipseOptions) -> None:
    """
    The handler will be called from a timer.
...
def on_timer_complete_2(e: ap.TimerEvent, options: _EllipseOptions) -> None:
    """
    The handler will be called when a timer has completed.

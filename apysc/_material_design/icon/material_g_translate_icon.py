"""Material icons' G translate icon class implementation.
"""
...
class MaterialGTranslateIcon(PathAndVarNameSettingBase):
    """
    Material icons' G translate icon class implementation.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_G_TRANSLATE_ICON

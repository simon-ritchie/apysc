...
class TestBeginFillInterface:
    ...
    def test_fill_color(self) -> None:
        ...
        assert (
            fill_color_1.variable_name != begin_fill_interface.fill_color.variable_name
        )
    ...
    def test_fill_alpha(self) -> None:
        ...
        assert (
            fill_alpha_1.variable_name != begin_fill_interface.fill_alpha.variable_name
        )
    ...
    def test__make_snapshot(self) -> None:
        begin_fill_interface: BeginFillInterface = BeginFillInterface()
        begin_fill_interface.begin_fill(color="#333333", alpha=0.5)
        ...
        assert begin_fill_interface._fill_color_snapshots[snapshot_name_1] == "#333333"
        assert begin_fill_interface._fill_alpha_snapshots[snapshot_name_1] == 0.5
        assert begin_fill_interface._snapshot_exists(snapshot_name=snapshot_name_1)
    ...
    def test__revert(self) -> None:
        ...
        begin_fill_interface.begin_fill(color="#222222", alpha=0.3)
        begin_fill_interface._run_all_revert_methods(snapshot_name=snapshot_name_1)
        assert begin_fill_interface.fill_color == "#333333"
        assert begin_fill_interface.fill_alpha == 0.5

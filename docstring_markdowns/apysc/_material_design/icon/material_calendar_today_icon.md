# `apysc._material_design.icon.material_calendar_today_icon` docstrings

## Module summary

Material icons' calendar today icon class implementation.

## `MaterialCalendarTodayIcon` class docstring

Material icons' calendar today icon class implementation.<hr>

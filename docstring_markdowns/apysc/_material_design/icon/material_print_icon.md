# `apysc._material_design.icon.material_print_icon` docstrings

## Module summary

Material icons' print icon class implementations.

## `MaterialPrintIcon` class docstring

Material icons' print icon class implementations.<hr>

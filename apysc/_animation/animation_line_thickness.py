...
class AnimationLineThickness(AnimationBase[_Target], Generic[_Target]):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._line_thickness = (
            to_apysc_val_from_builtin.get_copied_int_from_builtin_val(integer=thickness)
        )
        self._set_basic_animation_settings(
            target=target, duration=duration, delay=delay, easing=easing
        )
        super(AnimationLineThickness, self).__init__(variable_name=variable_name)

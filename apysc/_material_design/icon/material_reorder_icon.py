...
class MaterialReorderIcon(PathAndVarNameSettingBase):
    """
    Material icons' reorder icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M3 15h18v-2H3v2zm0 4h18v-2H3v2zm0-8h18V9H3v2zm0-6v2h18V5H3z"
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_REORDER_ICON

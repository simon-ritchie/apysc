...
class MaterialfilterAltOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `filter_alt` material icon.
    """

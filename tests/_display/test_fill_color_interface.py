...
class TestFillColorInterface:
    ...
    def test__update_fill_color_and_skip_appending_exp(self) -> None:
        ...
        assert fill_color_interface.fill_color == "#333333"
        expression: str = expression_data_util.get_current_expression()
        expected: str = f"{fill_color_interface.variable_name}.fill("
    ...
    def test__make_snapshot(self) -> None:
        ...
        fill_color_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        assert fill_color_interface._fill_color_snapshots[snapshot_name] == "#333333"
    ...
    def test__revert(self) -> None:
        ...
        fill_color_interface._run_all_make_snapshot_methods(snapshot_name=snapshot_name)
        fill_color_interface.fill_color = ap.String("#222222")
        fill_color_interface._run_all_revert_methods(snapshot_name=snapshot_name)
        assert fill_color_interface.fill_color == "#333333"
    ...
    def test__set_initial_fill_color_if_not_blank(self) -> None:
        fill_color_interface: FillColorInterface = FillColorInterface()
        fill_color_interface.variable_name = "test_fill_color_interface"
        fill_color_interface._set_initial_fill_color_if_not_blank(fill_color="")
        assert fill_color_interface.fill_color == ""
        fill_color_interface._set_initial_fill_color_if_not_blank(fill_color="0af")

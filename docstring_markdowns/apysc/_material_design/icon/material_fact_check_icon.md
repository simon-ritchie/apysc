# `apysc._material_design.icon.material_fact_check_icon` docstrings

## Module summary

Material icons' fact check icon class implementations.

## `MaterialFactCheckIcon` class docstring

Material icons' fact check icon class implementations.<hr>

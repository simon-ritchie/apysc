# `apysc._material_design.icon.material_card_membership_icon` docstrings

## Module summary

Material icons' card membership icon class implementation.

## `MaterialCardMembershipIcon` class docstring

Material icons' card membership icon class implementation.<hr>

"""Material icons' query builder icon class implementation.
"""
...
class MaterialQueryBuilderIcon(PathAndVarNameSettingBase):
    """
    Material icons' query builder icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_QUERY_BUILDER_ICON

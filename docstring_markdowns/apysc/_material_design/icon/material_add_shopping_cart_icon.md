# `apysc._material_design.icon.material_add_shopping_cart_icon` docstrings

## Module summary

Material icons' add shopping cart icon class implementations.

## `MaterialAddShoppingCartIcon` class docstring

Material icons' add shopping cart icon class implementations.<hr>

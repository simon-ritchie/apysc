...
class MaterialDangerousIcon(PathAndVarNameSettingBase):
    """
    Material icons' dangerous icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M15.73 3H8.27L3 8.27v7.46L8.27 21h7.46L21 15.73V8.27L15.73 3zM17 15.74L15.74 17 12 13.26 8.26 17 7 15.74 10.74 12 7 8.26 8.26 7 12 10.74 15.74 7 17 8.26 13.26 12 17 15.74z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_DANGEROUS_ICON

...
class MaterialLeaderBoardIcon(PathAndVarNameSettingBase):
    """
    Material icons' leader board icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M7.5,21H2V9h5.5V21z M14.75,3h-5.5v18h5.5V3z M22,11h-5.5v10H22V11z"
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_LEADER_BOARD_ICON

# `apysc._material_design.icon.material_supervised_user_circle_icon` docstrings

## Module summary

Material icons' supervised user circle icon class implementation.

## `MaterialSupervisedUserCircleIcon` class docstring

Material icons' supervised user circle icon class implementation.<hr>

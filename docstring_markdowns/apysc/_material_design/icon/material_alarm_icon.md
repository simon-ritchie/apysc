# `apysc._material_design.icon.material_alarm_icon` docstrings

## Module summary

Material icons' alarm icon class implementation.

## `MaterialAlarmIcon` class docstring

Material icons' alarm icon class implementation.<hr>

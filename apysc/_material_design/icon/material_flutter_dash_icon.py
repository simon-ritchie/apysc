...
class MaterialFlutterDashIcon(PathAndVarNameSettingBase):
    """
    Material icons' flutter dash icon class implementation.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_FLUTTER_DASH_ICON

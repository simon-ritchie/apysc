"""Material icons' store icon class implementations.
"""
...
class MaterialStoreIcon(PathAndVarNameSettingBase):
    """
    Material icons' store icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M20 4H4v2h16V4zm1 10v-2l-1-5H4l-1 5v2h1v6h10v-6h4v6h2v-6h1zm-9 4H6v-4h6v4z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_STORE_ICON

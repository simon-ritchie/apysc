...
def test_get_lint_hash_dir_path() -> None:
    ...
    assert dir_path == ("./.lint_and_doc_hash/.autopep8/")
...
def test_get_target_file_hash_file_path() -> None:
    file_path: str = lint_and_doc_hash_util.get_target_file_hash_file_path(
        file_path="./apysc/_display/sprite.py", hash_type=HashType.AUTOPEP8
    )
    expected: str = "./.lint_and_doc_hash/.autopep8/apysc/_display/sprite"
...
def test_save_target_files_hash() -> None:
    ...
    lint_and_doc_hash_util.save_target_files_hash(
        file_paths=[module_path_1, module_path_2], hash_type=HashType.AUTOPEP8
    )

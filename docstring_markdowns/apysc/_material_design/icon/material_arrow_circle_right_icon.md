# `apysc._material_design.icon.material_arrow_circle_right_icon` docstrings

## Module summary

Material icons' arrow circle right icon class implementation.

## `MaterialArrowCircleRightIcon` class docstring

Material icons' arrow circle right icon class implementation.<hr>

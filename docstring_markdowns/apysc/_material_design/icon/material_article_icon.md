# `apysc._material_design.icon.material_article_icon` docstrings

## Module summary

Material icons' article icon class implementations.

## `MaterialArticleIcon` class docstring

Material icons' article icon class implementations.<hr>

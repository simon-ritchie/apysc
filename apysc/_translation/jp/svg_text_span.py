...
MAPPING: Dict[str, str] = {
    ...
    ##################################################
    "- `fill_color`: Optional[Union[str, String]], optional": "- `fill_color`: Optional[Union[str, String]], optional",  # noqa
    ##################################################
    ...
    ##################################################
    "- `line_color`: Optional[Union[str, String]], optional": "- `line_color`: Optional[Union[str, String]], optional",  # noqa
    ##################################################
    ...
    ##################################################
    "- `fill_color`: str or String, optional": "- `fill_color`: str or String, optional",  # noqa
    ##################################################
    ...
    ##################################################
    "- `line_color`: str or String, optional": "- `line_color`: str or String, optional",  # noqa
    ##################################################

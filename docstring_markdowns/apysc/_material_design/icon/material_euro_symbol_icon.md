# `apysc._material_design.icon.material_euro_symbol_icon` docstrings

## Module summary

Material euro symbol icon class implementation.

## `MaterialEuroSymbolIcon` class docstring

Material euro symbol icon class implementation.<hr>

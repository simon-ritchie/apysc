# `apysc._material_design.icon.material_supervisor_account_icon` docstrings

## Module summary

Material icons' supervisor account icon class implementations.

## `MaterialSupervisorAccountIcon` class docstring

Material icons' supervisor account icon class implementations.<hr>

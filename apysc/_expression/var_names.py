...
MATERIAL_QUESTION_MARK_ICON: Final[str] = "mquestionmarki"
MATERIAL_GET_APP_ICON: Final[str] = "mgetappi"
MATERIAL_ADD_TASK_ICON: Final[str] = "maddtaski"
MATERIAL_HELP_CENTER_ICON: Final[str] = "mhelpcenteri"
MATERIAL_HOURGLASS_EMPTY_ICON: Final[str] = "mhourglassemptyi"
MATERIAL_TRENDING_FLAT_ICON: Final[str] = "mtrendingflati"
MATERIAL_ACCESSIBILITY_NEW_ICON: Final[str] = "maccessibilitynewi"
MATERIAL_RULE_ICON: Final[str] = "mrulei"
MATERIAL_THUMB_DOWN_ICON: Final[str] = "mthumbdowni"
MATERIAL_ADS_CLICK_ICON: Final[str] = "madsclicki"
MATERIAL_SOURCE_ICON: Final[str] = "msourcei"
MATERIAL_FIND_IN_PAGE_ICON: Final[str] = "mfindinpagei"
MATERIAL_DASHBOARD_CUSTOMIZE_ICON: Final[str] = "mdashboardcustomizei"
MATERIAL_SUPPORT_ICON: Final[str] = "msupporti"
MATERIAL_FLUTTER_DASH_ICON: Final[str] = "mflutterdashi"
MATERIAL_REDEEM_ICON: Final[str] = "mredeemi"
MATERIAL_CLOSE_FULL_SCREEN_ICON: Final[str] = "mclosefullscreeni"
MATERIAL_SWAP_VERT_ICON: Final[str] = "mswapverti"
MATERIAL_ARROW_CIRCLE_RIGHT_ICON: Final[str] = "marrowcirclerighti"
MATERIAL_VIEW_HEADLINE_ICON: Final[str] = "mviewheadlinei"
MATERIAL_RESTORE_ICON: Final[str] = "mrestorei"
MATERIAL_DANGEROUS_ICON: Final[str] = "mdangerousi"
MATERIAL_EURO_SYMBOL_ICON: Final[str] = "meurosymboli"
MATERIAL_GROUP_WORK_ICON: Final[str] = "mgroupworki"
MATERIAL_SENSORS_ICON: Final[str] = "msensorsi"
MATERIAL_COMPARE_ARROWS_ICON: Final[str] = "mcomparearrowsiconi"
MATERIAL_TABLE_VIEW_ICON: Final[str] = "mtableviewiconi"
MATERIAL_PRIVACY_TIP_ICON: Final[str] = "mprivacytipi"
MATERIAL_NIGHTLIGHT_ROUND_ICON: Final[str] = "mnightlightroundi"
MATERIAL_CURRENCY_EXCHANGE_ICON: Final[str] = "mcurrencyexchangei"
MATERIAL_HTTPS_ICON: Final[str] = "mhttpsi"
MATERIAL_TOC_ICON: Final[str] = "mtoci"
MATERIAL_BOOKMARKS_ICON: Final[str] = "mbookmarksi"
MATERIAL_CIRCLE_UP_ICON: Final[str] = "mcircleupi"
MATERIAL_TRACK_CHANGES_ICON: Final[str] = "mtrackchangesi"
MATERIAL_COPYRIGHT_ICON: Final[str] = "mcopyrighti"
MATERIAL_VIEW_MODULE_ICON: Final[str] = "mviewmodulei"
MATERIAL_GRADING_ICON: Final[str] = "mgradingi"
MATERIAL_PERM_MEDIA_ICON: Final[str] = "mpermmediai"
MATERIAL_QUERY_BUILDER_ICON: Final[str] = "mquerybuilderi"
MATERIAL_BUILD_CIRCLE_ICON: Final[str] = "mbuildcirclei"
MATERIAL_PERM_CONTRACT_CALENDAR_ICON: Final[str] = "mpermcontractcalendari"
MATERIAL_ZOOM_OUT_ICON: Final[str] = "mzoomouti"
MATERIAL_SETTING_PHONE_ICON: Final[str] = "msettingphonei"
MATERIAL_BACKUP_ICON: Final[str] = "mbackupi"
MATERIAL_PERM_PHONE_MSG_ICON: Final[str] = "mpermphonemsgi"
MATERIAL_SPEAKER_NOTES_ICON: Final[str] = "mspeakernotesi"
MATERIAL_BOOK_ONLINE_ICON: Final[str] = "mbookonlinei"
MATERIAL_CARD_MEMBERSHIP_ICON: Final[str] = "mcardmembershipi"
MATERIAL_LABEL_IMPORTANT_ICON: Final[str] = "mlabelimportanti"
MATERIAL_WYSIWYG_ICON: Final[str] = "mwysiwygi"
MATERIAL_FILE_PRESENT_ICON: Final[str] = "mfilepresenti"
MATERIAL_ARROW_CIRCLE_DOWN_ICON: Final[str] = "marrowcirclerightdowni"
MATERIAL_PAGE_VIEW_ICON: Final[str] = "mpageviewi"
MATERIAL_INTEGRATION_INSTRUCTION_ICON: Final[str] = "mintegrationinstructioni"
MATERIAL_CHANGE_HISTORY_ICON: Final[str] = "mchangehistoryi"
MATERIAL_TRENDING_DOWN_ICON: Final[str] = "mtrendingdowni"
MATERIAL_PERCENT_ICON: Final[str] = "mpercenticoni"
MATERIAL_SWIPE_ICON: Final[str] = "mswipei"
MATERIAL_CLASS_ICON: Final[str] = "mclassi"
MATERIAL_ACCESSIBLE_ICON: Final[str] = "maccessiblei"
MATERIAL_INFO_OUTLINE_ICON: Final[str] = "minfooutlinei"
MATERIAL_G_TRANSLATE_ICON: Final[str] = "mgtranslatei"
MATERIAL_OFFLINE_BOLT_ICON: Final[str] = "mofflinebolti"
MATERIAL_SETTINGS_BACKUP_RESTORE_ICON: Final[str] = "msettingsbackuprestorei"
MATERIAL_PRODUCTION_QUANTITY_LIMITS_ICON: Final[str] = "mproductionquantitylimitsi"
...
MATERIAL_VIEW_COLUMN_ICON: Final[str] = "mviewcolumni"
MATERIAL_SEGMENT_ICON: Final[str] = "msegmenti"
MATERIAL_SCHEDULE_SEND_ICON: Final[str] = "mschedulesendi"
MATERIAL_MAXIMIZE_ICON: Final[str] = "mmaximizei"
MATERIAL_BOOKMARK_ADD_ICON: Final[str] = "mbookmarkaddi"
MATERIAL_THUMBS_UP_DOWN_ICON: Final[str] = "mthumbsupdowni"
MATERIAL_SETTINGS_ETHERNET_ICON: Final[str] = "msettingsetherneti"
MATERIAL_THEATER_ICON: Final[str] = "mtheateri"
MATERIAL_VIEW_AGENDA_ICON: Final[str] = "mviewagendai"

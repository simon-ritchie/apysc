# `apysc._animation.animation_finish_mixin` docstrings

## Module summary

Class implementation for the animation_finish interface.

## `AnimationFinishMixIn` class docstring
...
- [animation_finish interface](https://simon-ritchie.github.io/apysc/en/animation_finish.html)
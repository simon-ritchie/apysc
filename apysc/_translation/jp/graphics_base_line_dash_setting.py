...
MAPPING: Dict[str, str] = {
    ...
    'This page explains the `GraphicsBase` class `line_dash_setting` property interface.':  # noqa
    ...
    'The getter or setter interface value becomes (or requires) the `LineDashSetting` instance value.':  # noqa

...
class TestXAxisSettings:
    ...
    def test___init__(self) -> None:
        setting: ap.XAxisSettings = ap.XAxisSettings(
            ...
            tick_text_fill_color="#0af",tick_max_num
        ...
        assert setting._line_color == ap.String("#666666")
        ...
        assert setting._axis_label_fill_color == ap.String("#333333")

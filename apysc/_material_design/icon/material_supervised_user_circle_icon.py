...
class MaterialsupervisedUserCircleIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the `supervised_user_circle` material icon.
    """

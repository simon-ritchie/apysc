# `apysc._animation.animation_x` docstrings
...
The animation class for the x-coordinate.<hr>
...
- [animation_x interface document](https://simon-ritchie.github.io/apysc/en/animation_x.html)

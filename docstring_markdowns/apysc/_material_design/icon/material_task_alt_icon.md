# `apysc._material_design.icon.material_task_alt_icon` docstrings

## Module summary

Material icons' task alt icon class implementations.

## `MaterialTaskAltIcon` class docstring

Material icons' task alt icon class implementations.<hr>

# `apysc._material_design.icon.material_schedule_icon` docstrings

## Module summary

Material icons' schedule icon class implementation.

## `MaterialScheduleIcon` class docstring

Material icons' schedule icon class implementation.<hr>

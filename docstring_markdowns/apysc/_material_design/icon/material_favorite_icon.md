# `apysc._material_design.icon.material_favorite_icon` docstrings

## Module summary

Material icons' favorite icon class implementation.

## `MaterialFavoriteIcon` class docstring

Material icons' favorite icon class implementation.<hr>

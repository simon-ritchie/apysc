# `apysc._material_design.icon.material_accessibility_new_icon` docstrings

## Module summary

Material icons' accessibility new icon class implementation.

## `MaterialAccessibilityNewIcon` class docstring

Material icons' accessibility new icon class implementation.<hr>

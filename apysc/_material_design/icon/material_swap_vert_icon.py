...
class MaterialSwapVertIcon(PathAndVarNameSettingBase):
    """
    Material icons' swap vert icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M16 17.01V10h-2v7.01h-3L15 21l4-3.99h-3zM9 3L5 6.99h3V14h2V6.99h3L9 3z"
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_SWAP_VERT_ICON

# `apysc._material_design.icon.material_today_icon` docstrings

## Module summary

Material icons' today icon class implementations.

## `MaterialTodayIcon` class docstring

Material icons' today icon class implementations.<hr>

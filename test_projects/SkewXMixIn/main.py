"""A test project for the SkewXMixIn class.
...
def main() -> None:
    ...
    rect_2: ap.Rectangle = sprite.graphics.draw_rect(x=150, y=50, width=50, height=50)
    options: _RectOptions = {"rectangle": rect_2}
    timer: ap.Timer = ap.Timer(on_timer, delay=ap.FPS.FPS_60, options=options)
    timer.start()

    rect_3: ap.Rectangle = sprite.graphics.draw_rect(x=250, y=50, width=50, height=50)

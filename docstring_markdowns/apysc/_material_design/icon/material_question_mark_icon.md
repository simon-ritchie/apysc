# `apysc._material_design.icon.material_question_mark_icon` docstrings

## Module summary

Material icons' question mark icon class implementation.

## `MaterialQuestionMarkIcon` class docstring

Material icons' question mark icon class implementation.<hr>

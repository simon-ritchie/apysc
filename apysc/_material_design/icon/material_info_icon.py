...
class MaterialInfoIcon(PathAndVarNameSettingBase):
    """
    Material icons' info icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_INFO_ICON

# `apysc._animation.animation_scale_x_from_point_mixin` docstrings

## Module summary

Class implementation for the animation_scale_x_from_point mix-in.

## `AnimationScaleXFromPointMixIn` class docstring
...
- [animation_scale_x_from_point interface](https://simon-ritchie.github.io/apysc/en/animation_scale_x_and_y_from_point.html)

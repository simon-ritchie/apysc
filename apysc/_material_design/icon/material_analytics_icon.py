...
class MaterialAnalyticsIcon(PathAndVarNameSettingBase):
    """
    Material icons' analytics icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-5h2v5zm4 0h-2v-3h2v3zm0-5h-2v-2h2v2zm4 5h-2V7h2v10z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_ANALYTICS_ICON

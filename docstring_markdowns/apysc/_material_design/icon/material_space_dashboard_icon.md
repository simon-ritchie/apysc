# `apysc._material_design.icon.material_space_dashboard_icon` docstrings

## Module summary

Material icons' space dashboard icon class implementation.

## `MaterialSpaceDashboardIcon` class docstring

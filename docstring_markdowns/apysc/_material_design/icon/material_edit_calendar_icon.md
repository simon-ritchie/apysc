# `apysc._material_design.icon.material_edit_calendar_icon` docstrings

## Module summary

Material icons' edit calendar icon class implementation.

## `MaterialEditCalendarIcon` class docstring

Material icons' edit calendar icon class implementation.<hr>

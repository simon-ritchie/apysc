# `apysc._animation.animation_fill_color` docstrings
...
- [animation_fill_color interface document](https://simon-ritchie.github.io/apysc/en/animation_fill_color.html)

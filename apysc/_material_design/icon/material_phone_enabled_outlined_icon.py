...
class MaterialphoneEnabledOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `phone_enabled` material icon.
    """

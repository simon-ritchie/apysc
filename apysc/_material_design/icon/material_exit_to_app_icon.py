...
class MaterialExitToAppIcon(PathAndVarNameSettingBase):
    """
    Material icons' exit to app icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M10.09 15.59L11.5 17l5-5-5-5-1.41 1.41L12.67 11H3v2h9.67l-2.58 2.59zM19 3H5c-1.11 0-2 .9-2 2v4h2V5h14v14H5v-4H3v4c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_EXIT_TO_APP_ICON

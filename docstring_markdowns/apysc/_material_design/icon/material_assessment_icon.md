# `apysc._material_design.icon.material_assessment_icon` docstrings

## Module summary

Material icons' assessment icon class implementations.

## `MaterialAssessmentIcon` class docstring

Material icons' assessment icon class implementations.<hr>

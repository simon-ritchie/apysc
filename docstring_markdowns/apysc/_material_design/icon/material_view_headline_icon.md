# `apysc._material_design.icon.material_view_headline_icon` docstrings

## Module summary

Material icons' view headline icon class implementation.

## `MaterialViewHeadlineIcon` class docstring

Material icons' view headline icon class implementation.<hr>

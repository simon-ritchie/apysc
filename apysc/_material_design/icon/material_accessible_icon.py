"""Material icons' accessible icon class implementation.
"""
...
class MaterialAccessibleIcon(PathAndVarNameSettingBase):
    """
    Material icons' accessible icon class implementation.
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_ACCESSIBLE_ICON

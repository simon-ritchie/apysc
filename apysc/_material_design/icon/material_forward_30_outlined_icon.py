...
class MaterialForward30OutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `forward_30` material icon.
    """

"""Material icons' info icon class implementation.
"""
...
class MaterialInfoIcon(MaterialIconBase):
    """
    Material icons' info icon class implementation.
    ...
    def __init__(
        ...
        *,
        ...
        variable_name: str = expression_variables_util.get_next_variable_name(
            type_name=var_names.MATERIAL_INFO_ICON,
        )
        super(MaterialInfoIcon, self).__init__(
            svg_path_value="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z",  # noqa

# `apysc._material_design.icon.material_pending_icon` docstrings

## Module summary

Material icons' pending icon class implementations.

## `MaterialPendingIcon` class docstring

Material icons' pending icon class implementations.<hr>

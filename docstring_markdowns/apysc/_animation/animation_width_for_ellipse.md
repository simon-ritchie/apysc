# `apysc._animation.animation_width_for_ellipse` docstrings
...
- [animation_width and animation_height interfaces document](https://simon-ritchie.github.io/apysc/en/animation_width_and_height.html)

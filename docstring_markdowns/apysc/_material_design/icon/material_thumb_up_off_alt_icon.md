# `apysc._material_design.icon.material_thumb_up_off_alt_icon` docstrings

## Module summary

Material icons' thumb up off alt icon class implementations.

## `MaterialThumbUpOffAltIcon` class docstring

Material icons' thumb up off alt icon class implementations.<hr>

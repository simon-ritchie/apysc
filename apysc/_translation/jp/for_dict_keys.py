...
MAPPING: Dict[str, str] = {
    ...
    ##################################################
    "  - A dictionary key type. This interface accepsts hashable types, such as the `String`, `Int`, or `Boolean`.": "  - 辞書のキーの型。このインターフェイスはハッシュ化可能な`String`、`Int`、`Boolean`といった型のみ受け付けます。",  # noqa
    ##################################################

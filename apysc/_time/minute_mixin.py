...
class MinuteMixIn(RevertMixIn):
    ...
    def _append_minute_getter_expression(self, *, minute_val: Int) -> None:
        ...
        expression: str = (
            f"{minute_val.variable_name} = {self_instance.variable_name}.getMinutes();"
        )
    ...
    def _append_minute_setter_expression(self, *, minute_val: Int) -> None:
        ...
        expression: str = (
            f"{self_instance.variable_name}.setMinutes({minute_val.variable_name});"
        )
        expression_data_util.append_js_expression(expression=expression)

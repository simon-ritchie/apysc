# `apysc._material_design.icon.material_close_full_screen_icon` docstrings

## Module summary

Material icons' close full screen icon class implementation.

## `MaterialCloseFullScreenIcon` class docstring

Material icons' close full screen icon class implementation.<hr>

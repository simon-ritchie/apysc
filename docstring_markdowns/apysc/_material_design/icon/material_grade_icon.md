# `apysc._material_design.icon.material_grade_icon` docstrings

## Module summary

Material icons' grade icon class implementations.

## `MaterialGradeIcon` class docstring

Material icons' grade icon class implementations.<hr>

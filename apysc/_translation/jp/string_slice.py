...
MAPPING: Dict[str, str] = {
    ...
    ##################################################
    "  - An end index of the slice range. If this argument is not specified, this medhod skips the end position\'s slicing.": "  - スライス範囲の終了インデックス。もしもこの引数が指定されなかった場合、このメソッドは終了位置のスライスをスキップします。",  # noqa
    ##################################################

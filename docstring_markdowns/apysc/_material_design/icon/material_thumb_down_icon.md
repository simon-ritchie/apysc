# `apysc._material_design.icon.material_thumb_down_icon` docstrings

## Module summary

Material icons' thumb down icon class implementation.

## `MaterialThumbDownIcon` class docstring

Material icons' thumb down icon class implementation.<hr>

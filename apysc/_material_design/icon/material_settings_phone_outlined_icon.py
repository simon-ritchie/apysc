...
class MaterialsettingsPhoneOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `settings_phone` material icon.
    """

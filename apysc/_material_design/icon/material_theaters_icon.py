"""Material icons' theaters icon class implementation.
"""
...
class MaterialTheatersIcon(PathAndVarNameSettingBase):
    """
    Material icons' theaters icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M18 3v2h-2V3H8v2H6V3H4v18h2v-2h2v2h8v-2h2v2h2V3h-2zM8 17H6v-2h2v2zm0-4H6v-2h2v2zm0-4H6V7h2v2zm10 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_THEATER_ICON

...
class MaterialsubtitlesOffOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `subtitles_off` material icon.
    """

# `apysc._material_design.icon.material_code_icon` docstrings

## Module summary

Material icons' code icon class implementations.

## `MaterialCodeIcon` class docstring

Material icons' code icon class implementations.<hr>

# `apysc._material_design.icon.material_fingerprint_icon` docstrings

## Module summary

Material icons' fingerprint icon class implementations.

## `MaterialFingerprintIcon` class docstring

Material icons' fingerprint icon class implementations.<hr>

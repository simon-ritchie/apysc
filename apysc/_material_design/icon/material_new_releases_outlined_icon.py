...
class MaterialnewReleasesOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `new_releases` material icon.
    """

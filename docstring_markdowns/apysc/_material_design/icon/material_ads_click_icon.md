# `apysc._material_design.icon.material_ads_click_icon` docstrings

## Module summary

Material icons' ads click icon class implementation.

## `MaterialAdsClickIcon` class docstring

Material icons' ads click icon class implementation.<hr>

...
def main() -> None:
    ...
    sprite.graphics.draw_path(
        path_data_list=[
            ...
            ap.PathData.Bezier2D(control_x=250, control_y=50, dest_x=300, dest_y=100),
            ap.PathData.Bezier2DContinual(x=400, y=100),
        ]
    )
    ...
    sprite.graphics.draw_path(
        path_data_list=[
            ...
            ap.PathData.Bezier3DContinual(
                control_x=650, control_y=150, dest_x=650, dest_y=100
            ),
        ]
    )

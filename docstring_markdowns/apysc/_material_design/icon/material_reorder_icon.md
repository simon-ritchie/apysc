# `apysc._material_design.icon.material_reorder_icon` docstrings

## Module summary

Material icons' reorder icon class implementation.

## `MaterialReorderIcon` class docstring

Material icons' reorder icon class implementation.<hr>

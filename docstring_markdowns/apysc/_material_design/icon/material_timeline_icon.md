# `apysc._material_design.icon.material_timeline_icon` docstrings

## Module summary

Material icons' timeline icon class implementations.

## `MaterialTimelineIcon` class docstring

Material icons' timeline icon class implementations.<hr>

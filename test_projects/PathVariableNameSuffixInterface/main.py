...
def main() -> None:
    ...
    ap.Path(
        path_data_list=[
            ap.PathMoveTo(
                x=50, y=50, variable_name_suffix='test_path_1_move_to'),
            ap.PathLineTo(
                x=150, y=50, variable_name_suffix='test_path_1_line_to'),
        ],
    ...
    sprite.graphics.draw_path(
        path_data_list=[
            ap.PathMoveTo(
                x=50, y=100, variable_name_suffix='test_path_1_move_to'),
            ap.PathLineTo(
                x=150, y=100, variable_name_suffix='test_path_1_line_to'),
        ],

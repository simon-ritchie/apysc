...
MAPPING: Dict[str, str] = {
    ...
    'This page explains the `GraphicsBase` class `line_thickness` property interface.':  # noqa
    ...
    'The getter or setter interface value becomes (or requires) the `Int` value.':  # noqa

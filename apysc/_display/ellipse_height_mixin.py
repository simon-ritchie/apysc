...
class EllipseHeightMixIn(
    ...
    _ellipse_height_snapshots: Optional[Dict[str, int]] = None
    ...
    def _revert(self, *, snapshot_name: str) -> None:
        ...
        snapshot_name : str
            Target snapshot name.
        """
        self._ellipse_height._value = self._get_snapshot_val_if_exists(
            current_value=self._ellipse_height._value,
            snapshot_dict=self._ellipse_height_snapshots,
            snapshot_name=snapshot_name,
        )

...
class MaterialintegrationInstructionsIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the `integration_instructions` material icon.
    """

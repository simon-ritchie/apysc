...
class MaterialshoppingCartOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `shopping_cart` material icon.
    """

# `apysc._material_design.icon.material_paid_icon` docstrings

## Module summary

Material icons' pais icon class implementations.

## `MaterialPaidIcon` class docstring

Material icons' pais icon class implementations.<hr>

"""Material icons' offline bolt icon class implementation.
"""
...
class MaterialOfflineBoltIcon(PathAndVarNameSettingBase):
    """
    Material icons' offline bolt icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M12 2.02c-5.51 0-9.98 4.47-9.98 9.98s4.47 9.98 9.98 9.98 9.98-4.47 9.98-9.98S17.51 2.02 12 2.02zM11.48 20v-6.26H8L13 4v6.26h3.35L11.48 20z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_OFFLINE_BOLT_ICON

# `apysc._animation.animation_scale_x_from_center_interface` docstrings

## Module summary

Class implementation for the animation_scale_x_from_center interface.

## `AnimationScaleXFromCenterInterface` class docstring
...
- [animation_scale_x_from_center interface document](https://simon-ritchie.github.io/apysc/en/animation_scale_x_and_y_from_center.html)

# `apysc._material_design.icon.material_perm_contract_calendar_icon` docstrings

## Module summary

Material icons' perm contract calendar icon class implementation.

## `MaterialPermContractCalendarIcon` class docstring

Material icons' perm contract calendar icon class implementation.<hr>

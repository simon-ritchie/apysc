# `apysc._material_design.icon.material_perm_media_icon` docstrings

## Module summary

Material icons' perm media icon class implementation.

## `MaterialPermMediaIcon` class docstring

Material icons' perm media icon class implementation.<hr>

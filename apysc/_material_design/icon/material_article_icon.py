...
class MaterialArticleIcon(PathAndVarNameSettingBase):
    """
    Material icons' article icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_ARTICLE_ICON

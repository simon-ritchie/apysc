# `apysc._material_design.icon.material_backup_icon` docstrings

## Module summary

Material icons' backup icon class implementation.

## `MaterialBackupIcon` class docstring

Material icons' backup icon class implementation.<hr>

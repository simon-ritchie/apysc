# `apysc._material_design.icon.material_label_important_icon` docstrings

## Module summary

Material icons' label important icon class implementation.

## `MaterialLabelImportantIcon` class docstring

Material icons' label important icon class implementation.<hr>

# `apysc._material_design.icon.material_swap_vert_icon` docstrings

## Module summary

Material icons' swap vert icon class implementation.

## `MaterialSwapVertIcon` class docstring

Material icons' swap vert icon class implementation.<hr>

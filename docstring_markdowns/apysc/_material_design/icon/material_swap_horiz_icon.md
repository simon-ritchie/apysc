# `apysc._material_design.icon.material_swap_horiz_icon` docstrings

## Module summary

Material icons' swap horiz icon class implementations.

## `MaterialSwapHorizIcon` class docstring

Material icons' swap horiz icon class implementations.<hr>

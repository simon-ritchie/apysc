...
class MaterialpermPhoneMsgOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `perm_phone_msg` material icon.
    """

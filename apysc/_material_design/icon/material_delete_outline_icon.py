...
class MaterialDeleteOutlineIcon(PathAndVarNameSettingBase):
    """
    Material icons' delete outline icon class implementations.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9zm7.5-5l-1-1h-5l-1 1H5v2h14V4z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_DELETE_OUTLINE_ICON

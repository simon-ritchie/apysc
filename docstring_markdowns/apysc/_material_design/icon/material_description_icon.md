# `apysc._material_design.icon.material_description_icon` docstrings

## Module summary

Material icons' description icon class implementation.

## `MaterialDescriptionIcon` class docstring

Material icons' description icon class implementation.<hr>

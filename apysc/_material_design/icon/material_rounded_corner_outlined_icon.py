...
class MaterialRoundedCornerOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `rounded_corner` material icon.
    """

...
def main() -> None:
    ...
    animation_fill_alpha: ap.AnimationFillAlpha = rectangle.animation_fill_alpha(
        alpha=0.5, duration=1000, delay=500, easing=ap.Easing.EASE_OUT_QUINT
    )
    animation_fill_alpha.animation_complete(on_animation_complete_1)
    animation_fill_alpha.start()
...
def on_animation_complete_1(e: ap.AnimationEvent[ap.Rectangle], options: dict) -> None:
    ...
    animation_fill_alpha.animation_complete(on_animation_complete_2)
    animation_fill_alpha.start()

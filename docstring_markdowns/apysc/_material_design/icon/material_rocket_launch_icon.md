# `apysc._material_design.icon.material_rocket_launch_icon` docstrings

## Module summary

Material icons' rocket launch icon class implementation.

## `MaterialRocketLaunchIcon` class docstring

Material icons' rocket launch icon class implementation.<hr>

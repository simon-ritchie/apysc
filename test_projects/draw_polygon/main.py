...
def main() -> None:
    ...
    sprite.graphics.line_style(color="#fff", thickness=10, joints=ap.LineJoints.BEVEL)
    ...
    polygon_2: ap.Polygon = sprite.graphics.draw_polygon(
        points=[ap.Point2D(200, 50), ap.Point2D(300, 50), ap.Point2D(250, 100)]
    )
...
def on_polygon_click(e: ap.MouseEvent[ap.Polygon], options: dict) -> None:
    """

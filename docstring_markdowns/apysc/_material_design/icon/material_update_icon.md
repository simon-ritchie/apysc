# `apysc._material_design.icon.material_update_icon` docstrings

## Module summary

Material icons' update icon class implementations.

## `MaterialUpdateIcon` class docstring

Material icons' update icon class implementations.<hr>

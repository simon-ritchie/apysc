...
updating line thickness interface value.
...
def main() -> None:
    ...
    timer_1: ap.Timer = ap.Timer(
        on_timer_1, delay=ap.FPS.FPS_60, repeat_count=10, options=options
    )
...
def on_timer_complete_1(e: ap.TimerEvent, options: _RectOptions) -> None:
    ...
    timer_2: ap.Timer = ap.Timer(
        on_timer_2, delay=ap.FPS.FPS_60, repeat_count=10, options=options
    )

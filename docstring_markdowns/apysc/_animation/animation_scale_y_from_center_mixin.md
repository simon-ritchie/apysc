# `apysc._animation.animation_scale_y_from_center_mixin` docstrings

## Module summary

Class implementation for the animation_scale_y_from_center mix-in.

## `AnimationScaleYFromCenterMixIn` class docstring

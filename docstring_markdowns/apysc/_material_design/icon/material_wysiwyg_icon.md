# `apysc._material_design.icon.material_wysiwyg_icon` docstrings

## Module summary

Material icons' wysiwyg icon class implementation.

## `MaterialWysiwygIcon` class docstring

Material icons' wysiwyg icon class implementation.<hr>

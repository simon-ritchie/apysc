# `apysc._material_design.icon.material_highlight_off_icon` docstrings

## Module summary

Material icons' highlight off icon class implementations.

## `MaterialHighlightOffIcon` class docstring

Material icons' highlight off icon class implementations.<hr>

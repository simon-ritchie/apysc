...
class MaterialLabelImportantIcon(PathAndVarNameSettingBase):
    """
    Material icons' label important icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M3.5 18.99l11 .01c.67 0 1.27-.33 1.63-.84L20.5 12l-4.37-6.16c-.36-.51-.96-.84-1.63-.84l-11 .01L8.34 12 3.5 18.99z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_LABEL_IMPORTANT_ICON

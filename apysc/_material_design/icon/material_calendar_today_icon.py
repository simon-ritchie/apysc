...
class MaterialCalendarTodayIcon(PathAndVarNameSettingBase):
    """
    Material icons' calendar today icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M20 3h-1V1h-2v2H7V1H5v2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 18H4V8h16v13z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_CALENDAR_TODAY_ICON

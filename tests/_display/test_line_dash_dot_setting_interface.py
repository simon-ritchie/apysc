...
class TestLineDashDotSettingInterface:
    ...
    def test__initialize_line_dash_dot_setting_if_not_initialized(self) -> None:
        ...
        interface._initialize_line_dash_dot_setting_if_not_initialized()
        assert isinstance(interface._line_dash_dot_setting, ap.LineDashDotSetting)
    ...
    def test__update_line_dash_dot_setting_and_skip_appending_exp(self) -> None:
        interface: LineDashDotSettingInterface = LineDashDotSettingInterface()
        interface._update_line_dash_dot_setting_and_skip_appending_exp(value=None)
        assert interface._line_dash_dot_setting is None
        ...
        assert_raises(
            ...
            callable_=interface._update_line_dash_dot_setting_and_skip_appending_exp,

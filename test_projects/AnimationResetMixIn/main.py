"""A test project for the AnimationResetMixIn class.
...
def main() -> None:
    ...
    rectangle_1.animation_move(
        x=500, y=50, duration=5000, easing=ap.Easing.EASE_OUT_QUINT
    ).start()
    ...
    timer_1: ap.Timer = ap.Timer(
        handler=on_timer_1, delay=2000, repeat_count=1, options=options
    )
    timer_1.start()

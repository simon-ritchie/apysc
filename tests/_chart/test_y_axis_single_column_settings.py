...
class TestYAxisSingleColumnSettings:
    ...
    def test___init__(self) -> None:
        settings: ap.YAxisSingleColumnSettings = ap.YAxisSingleColumnSettings(
            ...
            axis_label_fill_color=ap.Color("#777"),
        ...
        assert settings._tick_text_fill_color == ap.Color("#666666")
        ...
        assert settings._line_color == ap.Color("#333333")
        ...
        assert settings._axis_label_fill_color == ap.Color("#777777")
        ...
        settings = ap.YAxisSingleColumnSettings(
            ...
            tick_text_fill_color=ap.Color("#777"),
            ...
            axis_label_fill_color=ap.Color("#888"),

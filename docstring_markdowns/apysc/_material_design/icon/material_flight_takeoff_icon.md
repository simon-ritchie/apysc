# `apysc._material_design.icon.material_flight_takeoff_icon` docstrings

## Module summary

Material icons' flight takeoff icon class implementations.

## `MaterialFlightTakeoffIcon` class docstring

Material icons' flight takeoff icon class implementations.<hr>

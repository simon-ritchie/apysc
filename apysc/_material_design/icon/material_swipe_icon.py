"""Material icons' swipe icon class implementation.
"""
...
class MaterialSwipeIcon(PathAndVarNameSettingBase):
    """
    Material icons' swipe icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M20.13,3.87C18.69,2.17,15.6,1,12,1S5.31,2.17,3.87,3.87L2,2v5h5L4.93,4.93c1-1.29,3.7-2.43,7.07-2.43 s6.07,1.14,7.07,2.43L17,7h5V2L20.13,3.87z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_SWIPE_ICON

# `apysc._material_design.icon.material_hourglass_empty_icon` docstrings

## Module summary

Material icons' hourglass empty icon class implementation.

## `MaterialHourglassEmptyIcon` class docstring

Material icons' hourglass empty icon class implementation.<hr>

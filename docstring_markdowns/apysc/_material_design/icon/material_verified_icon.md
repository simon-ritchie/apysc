# `apysc._material_design.icon.material_verified_icon` docstrings

## Module summary

Material icons' verified icon class implementation.

## `MaterialVerifiedIcon` class docstring

Material icons' verified icon class implementation.<hr>

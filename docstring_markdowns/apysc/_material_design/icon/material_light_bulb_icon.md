# `apysc._material_design.icon.material_light_bulb_icon` docstrings

## Module summary

Material icons' light bulb icon class implementations.

## `MaterialLightBulbIcon` class docstring

Material icons' light bulb icon class implementations.<hr>

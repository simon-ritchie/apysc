...
MAPPING: Dict[str, str] = {
    ...
    'The getter or setter interface value becomes (or requires) the `Number` value (0.0 to 1.0).':  # noqa
    ...
    '**[Interface summary]** Get this instance\'s line alpha (opacity).<hr>':  # noqa

<span class="inconspicuous-txt">※この翻訳ドキュメントはスクリプトによって出力・同期されています。内容が怪しそうな場合はGitHubにissueを追加したり[英語の原文](docs_src/source/about_handler_options_type.md)の確認をお願いします。</span>

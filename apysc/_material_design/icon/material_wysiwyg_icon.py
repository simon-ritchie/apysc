...
class MaterialWysiwygIcon(PathAndVarNameSettingBase):
    """
    Material icons' wysiwyg icon class implementation.
    ...
    def _get_svg_path_value(self) -> str:
        ...
        """
        return "M19,3H5C3.89,3,3,3.9,3,5v14c0,1.1,0.89,2,2,2h14c1.1,0,2-0.9,2-2V5C21,3.9,20.11,3,19,3z M19,19H5V7h14V19z M17,12H7v-2 h10V12z M13,16H7v-2h6V16z"  # noqa
    ...
    def _get_icon_variable_name(self) -> str:
        ...
        return var_names.MATERIAL_WYSIWYG_ICON

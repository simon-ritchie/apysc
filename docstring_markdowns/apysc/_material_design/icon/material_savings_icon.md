# `apysc._material_design.icon.material_savings_icon` docstrings

## Module summary

Material icons' savings icon class implementations.

## `MaterialSavingsIcon` class docstring

Material icons' savings icon class implementations.<hr>

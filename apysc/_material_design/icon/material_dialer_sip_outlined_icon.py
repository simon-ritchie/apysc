...
class MaterialdialerSipOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `dialer_sip` material icon.
    """

...
class MaterialHowToVoteOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `how_to_vote` material icon.
    """

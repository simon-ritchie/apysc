...
updaging ellipse size interface value.

Command examples:
$ python test_projects/timer_circular_calling_ellipse_size/main.py
$ python timer_circular_calling_ellipse_size/main.py
"""
...
def main() -> None:
    ...
    rectangle: ap.Rectangle = sprite.graphics.draw_round_rect(
        ...
        ellipse_width=150, ellipse_height=150)
...
def on_timer_1(e: ap.TimerEvent, options: Dict[str, Any]) -> None:
    ...
    rectangle.ellipse_size += 1
    # ap.assert_equal(rectangle.ellipse_size, rectangle.ellipse_width)
    # ap.assert_equal(rectangle.ellipse_size, rectangle.ellipse_height)

...
class MaterialpermDataSettingOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `perm_data_setting` material icon.
    """

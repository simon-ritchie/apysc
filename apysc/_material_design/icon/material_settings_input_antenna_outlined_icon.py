...
class MaterialsettingsInputAntennaOutlinedIcon(FixedHtmlSvgIconBase):
    """
    The class implementation for the outlined `settings_input_antenna` material icon.
    """

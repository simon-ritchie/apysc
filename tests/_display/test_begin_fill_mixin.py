...
class TestBeginFillMixIn:
    ...
    def test_begin_fill(self) -> None:
        ...
        begin_fill_mixin.begin_fill(color="#333")
        assert begin_fill_mixin.fill_color == ap.String("#333333")
        assert begin_fill_mixin.fill_alpha == 1.0

        begin_fill_mixin.begin_fill(color="#333", alpha=0.5)
        assert begin_fill_mixin.fill_alpha == 0.5

        begin_fill_mixin.begin_fill(
    ...
    def test_fill_color(self) -> None:
        ...
        assert (
            fill_color_1.variable_name != begin_fill_mixin.fill_color.variable_name
        )
    ...
    def test_fill_alpha(self) -> None:
        ...
        begin_fill_mixin._fill_color = ap.String("")
        begin_fill_mixin._fill_alpha = ap.Number(1.0)
        begin_fill_mixin.begin_fill(color="#333", alpha=0.2)
        assert begin_fill_mixin.fill_alpha == 0.2

        fill_alpha_1: ap.Number = begin_fill_mixin.fill_alpha
        assert (
            fill_alpha_1.variable_name != begin_fill_mixin.fill_alpha.variable_name
        )
    ...
    def test__initialize_fill_color_if_not_initialized(self) -> None:
        ...
        begin_fill_mixin._fill_color = ap.String("#333333")
        begin_fill_mixin._initialize_fill_color_if_not_initialized()
        assert begin_fill_mixin.fill_color == "#333333"
    ...
    def test__make_snapshot(self) -> None:
        ...
        begin_fill_mixin._run_all_make_snapshot_methods(
        ...
        begin_fill_mixin._fill_color.value = "#222222"
        begin_fill_mixin._run_all_make_snapshot_methods(
            snapshot_name=snapshot_name_1
        )
        assert begin_fill_mixin._fill_color_snapshots[snapshot_name_1] == "#333333"
    ...
    def test__revert(self) -> None:
        ...
        begin_fill_mixin.begin_fill(color="#222222", alpha=0.3)
        ...
        begin_fill_mixin.begin_fill(color="#222222", alpha=0.3)
        begin_fill_mixin._run_all_revert_methods(snapshot_name=snapshot_name_1)
        assert begin_fill_mixin.fill_color == "#222222"

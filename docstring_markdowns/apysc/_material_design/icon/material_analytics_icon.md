# `apysc._material_design.icon.material_analytics_icon` docstrings

## Module summary

Material icons' analytics icon class implementations.

## `MaterialAnalyticsIcon` class docstring

Material icons' analytics icon class implementations.<hr>

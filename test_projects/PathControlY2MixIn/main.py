"""The test project for the PathControlY2MixIn class.

Command examples:
$ python test_projects/PathControlY2MixIn/main.py
"""
...
def main() -> None:
    ...
    interface: PathControlY2MixIn = PathControlY2MixIn()
    interface.control_y2 = ap.Number(10)
...
def on_timer_1(e: ap.TimerEvent, options: _InterfaceOptions) -> None:
    ...
    """
    ap.assert_equal(10, options["interface"].control_y2)
    options["interface"].control_y2 = ap.Number(20)
...
def on_timer_2(e: ap.TimerEvent, options: _InterfaceOptions) -> None:
    ...
    options : dict
        Optional arguments dictionary.
    """
    ap.assert_equal(20, options["interface"].control_y2)
    options["interface"].control_y2 = ap.Number(10)
    ap.Timer(on_timer_1, delay=1000, repeat_count=1, options=options).start()

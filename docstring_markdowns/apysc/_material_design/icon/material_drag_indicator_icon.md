# `apysc._material_design.icon.material_drag_indicator_icon` docstrings

## Module summary

Material drag indicator icon class implementation.

## `MaterialDragIndicatorIcon` class docstring

Material drag indicator icon class implementation.<hr>
